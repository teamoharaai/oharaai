...
export const MOCK_GOALS: GoalWithMeasurables[] = [
  {
    ...
    measurables: [
      ...
      { id: 'm3', goalId: '1', title: 'Journal run reflections', type: 'checklist', frequency: 'weekly', currentValue: 0, isAiSuggested: false, sortOrder: 2, createdAt: new Date(), updatedAt: new Date() },
    ],
  },
  {
    id: '2',
    ...
    measurables: [
      ...
      { id: 'm5', goalId: '2', title: 'Watch Spanish media', type: 'habit', frequency: 'daily', currentValue: 0, isAiSuggested: false, sortOrder: 1, createdAt: new Date(), updatedAt: new Date() },
    ],
  },
  {
    id: '3',
    ...
    measurables: [
      ...
      { id: 'm7', goalId: '3', title: 'Daily coding session', type: 'habit', frequency: 'daily', currentValue: 1, isAiSuggested: false, sortOrder: 1, createdAt: new Date(), updatedAt: new Date() },
    ],
  },
  {
    id: '4',
  ...
  },
  {
    ...
    measurables: [
      ...
      { id: 'm10', goalId: '5', title: 'Review budget weekly', type: 'habit', frequency: 'weekly', currentValue: 1, isAiSuggested: true, sortOrder: 1, createdAt: new Date(), updatedAt: new Date() },
    ],
  },
];
