...
### Added
- Added `docs/ECHO_PIPELINE.md` and a canonical Echo/Entries section in `docs/API_CONTRACT.md` documenting the live Notes-versus-Reflections flow, owner-only data boundary, explicit sharing behavior, legacy `echo_entries` split, and the shared web/iOS create/read/autosave/delete contract.
