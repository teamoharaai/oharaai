...
- supabase/migrations/ holds 6 narrative baseline files (001-006), squashed
  2026-06-24 from the original 26 incremental migrations. Next new migration: 007.
...
- handle_new_user()/profile-row-on-signup is known broken (no trigger creates a
  profiles row on signup). Tracked as separate work, not fixed by the squash.
