...
export default function GoalsScreen() {
  ...
  return (
    <View className="flex-1 bg-cream items-center justify-center px-6">
      <Text className="text-2xl font-bold text-near-black mb-2">Goals</Text>
      ...
      >
        <Text className="text-base text-cream font-medium">Create a goal</Text>
      </TouchableOpacity>
      <TouchableOpacity
        className="rounded-full px-8 py-3"
        onPress={handleLogout}
      >
        <Text className="text-base text-muted font-medium">Log out</Text>
      </TouchableOpacity>
    </View>
  );
}
