...
- Feedback: danger/overdue #C0483A (`feedback.danger`)
...
- ProjectCard.tsx: teal status dot, project title + description, chevron toggle (collapsed by default); expands to a 2-column grid of GoalRingCards. Due-date color via `feedback.danger` when overdue.
