...
// fail on the revoked grant. Server-side-only callers such as the folder
// DELETE-reassign route use this to guarantee creation. New entry creation
// resolves General inside its atomic database transaction instead.
