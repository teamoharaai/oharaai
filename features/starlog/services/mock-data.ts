...
export const MOCK_STARLOG_ENTRIES: StarlogEntry[] = [
  {
    ...
    userId: 'mock-user',
    goalId: '1',
    rawText: 'First run done! Only made it 1.5 miles but felt good to start. Legs were heavy but I pushed through the last quarter mile.',
    aiOptedIn: true,
  ...
  },
  {
    ...
    userId: 'mock-user',
    goalId: '1',
    rawText: 'Skipped my run today. Work was brutal and I just could not find the energy. Feeling guilty about it.',
    aiOptedIn: true,
  ...
  },
  {
    ...
    userId: 'mock-user',
    goalId: '1',
    rawText: 'Hit 2 miles today without stopping. Progress!',
